...
**Still open from this list:** item 6 (forwarded-message sender-as-default-audience — a real feature needing its own design pass), item 7 (color picker UI applying a different shade than what was shown/picked — frontend-only, not yet looked at).
